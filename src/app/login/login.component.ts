// Login component uses AuthService when working with Observable objects.
// It also calls StorageService methods to check loggedIn status and save user information to sesson storage.
